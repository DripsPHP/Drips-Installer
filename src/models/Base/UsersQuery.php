...
use models\Users as ChildUsers;
 ...
 * @method     ChildUsersQuery orderByVorname($order = Criteria::ASC) Order by the vorname column
 * @method     ChildUsersQuery orderByNachname($order = Criteria::ASC) Order by the nachname column
 * @method     ChildUsersQuery orderByAnzahlLogins($order = Criteria::ASC) Order by the anzahl_logins column
 *
 * @method     ChildUsersQuery groupById() Group by the id column
 * @method     ChildUsersQuery groupByEmail() Group by the email column
 * @method     ChildUsersQuery groupByVorname() Group by the vorname column
 * @method     ChildUsersQuery groupByNachname() Group by the nachname column
 * @method     ChildUsersQuery groupByAnzahlLogins() Group by the anzahl_logins column
 *
 ...
 * @method     ChildUsers findOneByVorname(string $vorname) Return the first ChildUsers filtered by the vorname column
 * @method     ChildUsers findOneByNachname(string $nachname) Return the first ChildUsers filtered by the nachname column
 * @method     ChildUsers findOneByAnzahlLogins(int $anzahl_logins) Return the first ChildUsers filtered by the anzahl_logins column *
 ...
 * @method     ChildUsers requireOneByVorname(string $vorname) Return the first ChildUsers filtered by the vorname column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUsers requireOneByNachname(string $nachname) Return the first ChildUsers filtered by the nachname column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUsers requireOneByAnzahlLogins(int $anzahl_logins) Return the first ChildUsers filtered by the anzahl_logins column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUsers[]|ObjectCollection findByVorname(string $vorname) Return ChildUsers objects filtered by the vorname column
 * @method     ChildUsers[]|ObjectCollection findByNachname(string $nachname) Return ChildUsers objects filtered by the nachname column
 * @method     ChildUsers[]|ObjectCollection findByAnzahlLogins(int $anzahl_logins) Return ChildUsers objects filtered by the anzahl_logins column
...
abstract class UsersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \models\Base\UsersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\models\\Users', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, email, vorname, nachname, anzahl_logins FROM users WHERE id = :p0';
        try {
    ...
    public function filterByVorname($vorname = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UsersTableMap::COL_VORNAME, $vorname, $comparison);
    }
    ...
    public function filterByNachname($nachname = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UsersTableMap::COL_NACHNAME, $nachname, $comparison);
    }

    /**
     * Filter the query on the anzahl_logins column
     *
     * Example usage:
     * <code>
     * $query->filterByAnzahlLogins(1234); // WHERE anzahl_logins = 1234
     * $query->filterByAnzahlLogins(array(12, 34)); // WHERE anzahl_logins IN (12, 34)
     * $query->filterByAnzahlLogins(array('min' => 12)); // WHERE anzahl_logins > 12
     * </code>
     *
     * @param     mixed $anzahlLogins The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return $this|ChildUsersQuery The current query, for fluid interface
     */
    public function filterByAnzahlLogins($anzahlLogins = null, $comparison = null)
    {
        if (is_array($anzahlLogins)) {
            $useMinMax = false;
            if (isset($anzahlLogins['min'])) {
                $this->addUsingAlias(UsersTableMap::COL_ANZAHL_LOGINS, $anzahlLogins['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($anzahlLogins['max'])) {
                $this->addUsingAlias(UsersTableMap::COL_ANZAHL_LOGINS, $anzahlLogins['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UsersTableMap::COL_ANZAHL_LOGINS, $anzahlLogins, $comparison);
    }
