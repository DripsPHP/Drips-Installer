...
abstract class Users implements ActiveRecordInterface 
{
    ...
    /**
     * The value for the anzahl_logins field.
     * 
     * @var        int
     */
    protected $anzahl_logins;
    ...
    /**
     * Get the [anzahl_logins] column value.
     * 
     * @return int
     */
    public function getAnzahlLogins()
    {
        return $this->anzahl_logins;
    }
    ...
    public function setVorname($v)
    {
        ...
        if ($this->vorname !== $v) {
            $this->vorname = $v;
            $this->modifiedColumns[UsersTableMap::COL_VORNAME] = true;
        }
    ...
    public function setNachname($v)
    {
        ...
        if ($this->nachname !== $v) {
            $this->nachname = $v;
            $this->modifiedColumns[UsersTableMap::COL_NACHNAME] = true;
        }
    ...
    /**
     * Set the value of [anzahl_logins] column.
     * 
     * @param int $v new value
     * @return $this|\models\Users The current object (for fluent API support)
     */
    public function setAnzahlLogins($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->anzahl_logins !== $v) {
            $this->anzahl_logins = $v;
            $this->modifiedColumns[UsersTableMap::COL_ANZAHL_LOGINS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UsersTableMap::translateFieldName('Vorname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vorname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UsersTableMap::translateFieldName('Nachname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nachname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UsersTableMap::translateFieldName('AnzahlLogins', TableMap::TYPE_PHPNAME, $indexType)];
            $this->anzahl_logins = (null !== $col) ? (int) $col : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_VORNAME)) {
            $modifiedColumns[':p' . $index++]  = 'vorname';
        }
        if ($this->isColumnModified(UsersTableMap::COL_NACHNAME)) {
            $modifiedColumns[':p' . $index++]  = 'nachname';
        }
        if ($this->isColumnModified(UsersTableMap::COL_ANZAHL_LOGINS)) {
            $modifiedColumns[':p' . $index++]  = 'anzahl_logins';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'nachname':                        
                        ...
                        break;
                    case 'anzahl_logins':                        
                        $stmt->bindValue($identifier, $this->anzahl_logins, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getVorname(),
            $keys[3] => $this->getNachname(),
            $keys[4] => $this->getAnzahlLogins(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setVorname($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setNachname($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setAnzahlLogins($arr[$keys[4]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsersTableMap::COL_VORNAME)) {
            $criteria->add(UsersTableMap::COL_VORNAME, $this->vorname);
        }
        if ($this->isColumnModified(UsersTableMap::COL_NACHNAME)) {
            $criteria->add(UsersTableMap::COL_NACHNAME, $this->nachname);
        }
        if ($this->isColumnModified(UsersTableMap::COL_ANZAHL_LOGINS)) {
            $criteria->add(UsersTableMap::COL_ANZAHL_LOGINS, $this->anzahl_logins);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setAnzahlLogins($this->getAnzahlLogins());
        if ($makeNew) {
            $copyObj->setNew(true);
