...
class UsersTableMap extends TableMap
{
     ...
     */
    const COL_VORNAME = 'users.vorname';

    /**
     * the column name for the nachname field
     */
    const COL_NACHNAME = 'users.nachname';

    /**
     * the column name for the anzahl_logins field
     */
    const COL_ANZAHL_LOGINS = 'users.anzahl_logins';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Email', 'Vorname', 'Nachname', 'AnzahlLogins', ),
        self::TYPE_CAMELNAME     => array('id', 'email', 'vorname', 'nachname', 'anzahlLogins', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_EMAIL, UsersTableMap::COL_VORNAME, UsersTableMap::COL_NACHNAME, UsersTableMap::COL_ANZAHL_LOGINS, ),
        self::TYPE_FIELDNAME     => array('id', 'email', 'vorname', 'nachname', 'anzahl_logins', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Email' => 1, 'Vorname' => 2, 'Nachname' => 3, 'AnzahlLogins' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'email' => 1, 'vorname' => 2, 'nachname' => 3, 'anzahlLogins' => 4, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_EMAIL => 1, UsersTableMap::COL_VORNAME => 2, UsersTableMap::COL_NACHNAME => 3, UsersTableMap::COL_ANZAHL_LOGINS => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'email' => 1, 'vorname' => 2, 'nachname' => 3, 'anzahl_logins' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('vorname', 'Vorname', 'VARCHAR', true, 30, null);
        $this->addColumn('nachname', 'Nachname', 'VARCHAR', true, 50, null);
        $this->addColumn('anzahl_logins', 'AnzahlLogins', 'INTEGER', true, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersTableMap::COL_VORNAME);
            $criteria->addSelectColumn(UsersTableMap::COL_NACHNAME);
            $criteria->addSelectColumn(UsersTableMap::COL_ANZAHL_LOGINS);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.email');
            $criteria->addSelectColumn($alias . '.vorname');
            $criteria->addSelectColumn($alias . '.nachname');
            $criteria->addSelectColumn($alias . '.anzahl_logins');
        }
    }
